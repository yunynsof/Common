 ...
 */
public class SprApacheHttpConection implements Closeable {

	/** The Constant LOGGER. */
	private static final Logger LOGGER = Logger.getLogger(SprApacheHttpConection.class);
	 ...
	 */
	public SprApacheHttpConection(final int readTimeout, final int connectTimeout) throws AdapterException {
		...
		_idThread.setName("IdleConnectionMonitorThread_Spr");
		_idThread.start();
	 ...
	 * @param statusCodeExpected the status code expected
	 * @return the string
	 * @throws AdapterException the adapter exception
	 */
	public String sendHttpRequest(final String hostIp, final int port, final HttpRequest request, final int statusCodeExpected) throws AdapterException {
